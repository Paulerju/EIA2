namespace OMDF{
   ...
   crc2 = <CanvasRenderingContext2D>canvas.getContext("2d");
    let chicken = new Animal("chicken","bock","yellow",1);
    let cow = new Animal("cow","muh","grass",3);
    let dog = new Animal("dog","wuf","meat",2);
    let donkey = new Animal("donkey","ehah","stroh",2);
    let pig = new Animal("pig","oink","brown",3);
