...
(function (OMDF) {
    ...
    function Song() {
        ...
        if (i < 2) {
            ...
            console.log("With a ");
            console.log("Cow: " + OMDF.cow.sound + " " + OMDF.cow.sound);
            console.log("here,");
            console.log("and a");
            console.log("Cow: " + OMDF.cow.sound + " " + OMDF.cow.sound);
            console.log("there.");
            console.log("Here a ");
            console.log("Cow: " + OMDF.cow.sound);
            console.log("there a ");
            console.log("Cow: " + OMDF.cow.sound);
            console.log("Everywhere a ");
            console.log("Cow: " + OMDF.cow.sound + " " + OMDF.cow.sound);
        ...
        if (i < 3) {
            ...
            console.log("And on that farm he had a cow, E-I-E-I-O.");
            console.log("With a ");
            console.log("Pig: " + OMDF.pig.sound + " " + OMDF.pig.sound);
            console.log("here,");
            console.log("and a");
            console.log("Pig: " + OMDF.pig.sound + " " + OMDF.pig.sound);
            console.log("there.");
            console.log("Here a ");
            console.log("Pig: " + OMDF.pig.sound);
            console.log("there a ");
            console.log("Pig: " + OMDF.pig.sound);
            console.log("Everywhere a ");
            console.log("Pig: " + OMDF.pig.sound + " " + OMDF.pig.sound);
        ...
        if (i < 4) {
            ...
            console.log("And on that farm he had a cow, E-I-E-I-O.");
            console.log("With a ");
            console.log("Chicken: " + OMDF.chicken.sound + " " + OMDF.chicken.sound);
            console.log("here,");
            console.log("and a");
            console.log("Chicken: " + OMDF.chicken.sound + " " + OMDF.chicken.sound);
            console.log("there.");
            console.log("Here a ");
            console.log("Chicken: " + OMDF.chicken.sound);
            console.log("there a ");
            console.log("Chicken: " + OMDF.chicken.sound);
            console.log("Everywhere a ");
            console.log("Chicken: " + OMDF.chicken.sound + " " + OMDF.chicken.sound);
        ...
        if (i < 5) {
            ...
            console.log("And on that farm he had a cow, E-I-E-I-O.");
            console.log("With a ");
            console.log("Donkey: " + OMDF.donkey.sound + " " + OMDF.donkey.sound);
            console.log("here,");
            console.log("and a");
            console.log("Donkey: " + OMDF.donkey.sound + " " + OMDF.donkey.sound);
            console.log("there.");
            console.log("Here a ");
            console.log("Donkey: " + OMDF.donkey.sound);
            console.log("there a ");
            console.log("Donkey: " + OMDF.donkey.sound);
            console.log("Everywhere a ");
            console.log("Donkey: " + OMDF.donkey.sound + " " + OMDF.donkey.sound);
